...
export class Orders extends ClientSDK {
    ...
    async createOrder(
        ...
        options?: RequestOptions & { acceptHeaderOverride?: CreateOrderAcceptEnum }
        ...
        const [result$] = await this.matcher<operations.CreateOrderResponse>()
            .json(200, operations.CreateOrderResponse$, { key: "oneOf" })
            .bytes(200, operations.CreateOrderResponse$, { ctype: "application/xml", key: "Body" })
            .fail("4XX")
